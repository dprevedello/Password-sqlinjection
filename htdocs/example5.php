        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="topNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="example5.php">Esempio 5</a>
              </li>
            </ul>
                ...
                <div class="col-lg-6">
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <div class="text-center">
                      ...
                      <h4 class="mt-1 mb-5 pb-1">Esempio 5 SQL injection</h4>
                    </div>
    
                    <form method="POST" action="example5.php" class="novalidate">
