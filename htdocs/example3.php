        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="topNavbar">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="example3.php">Esempio 3</a>
              </li>
              <li class="nav-item">
                ...
                <div class="col-lg-6">
                  <div class="card-body p-md-5 mx-md-4">
                    ...
                    <div class="text-center">
                      ...
                      <h4 class="mt-1 mb-5 pb-1">Esempio 3 SQL injection</h4>
                    </div>
    
                    <form method="POST" action="example3.php" class="novalidate">
...
<?php
  ...
  if( isset($_POST['username']) && isset($_POST['password']) ){
    ...
    $sql = "SELECT nome
            FROM users_ex3
            WHERE username = '$username' AND password = SHA2(CONCAT('$pass', (SELECT salt FROM users_ex3 WHERE username = '$username')), 256);";
    $result = $db->query($sql);

    if ($result->num_rows > 0) {
      $row = $result->fetch_assoc();
      echo "<p class='small mb-0 alert alert-success' role='alert' data-mdb-color='success'><i class='fas fa-check-circle me-3'></i><b>Bentornato:</b> {$row['nome']}</p>";
    } else
